...
class TestRouterMounting:
    ...
    def test_included_routers_count(self):
        """App should have 11 included routers (as _IncludedRouter)."""
        included = [r for r in app.routes if type(r).__name__ == "_IncludedRouter"]
        # 11 routers: auth, receipts, categories, portfolios, holdings, market,
        # cash_flows, performance, prediction, drift, transactions
