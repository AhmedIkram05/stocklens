...
.
 5. Consumer: RN app via graphql-codegen from a committed `schema.graphql`;ONE screen converted.
 6. Docs: README section only (CONTEXT.md + ADR 010 exist — reference, don't re-plan.
